...
import { random, randomFloor, saveImage, getDateString } from "./utils";
...
class SceneApp extends Scene {
  ...
  _initTextures() {
    ...
    this._textureColor = Assets.get(`00${randomFloor(10)}`);
    // this._textureColor = Assets.get(`009`);
  }
  ...
  _initViews() {
    ...
    // const meshSphere = Geom.sphere(1, 12);
  ...
  update() {
    ...
    // this.container.scaleX = Math.cos(Scheduler.getElapsedTime() * 0.1) * 2;
    this.container.y = Math.sin(Scheduler.getElapsedTime() * 0.1) * 2;
  }
  ...
  render() {
    ...
    GL.viewport(g, 0, g, g);
    this._dCopy.draw(this._textureColor);
